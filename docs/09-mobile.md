...
- [x] «Premium Human Civic Mobile UI» corrective sprint: Home, murojaatlar, sozlamalar, bottom navigation, hero, statistika va murojaat kartalari tonal qatlamlar hamda superellipse geometriya bilan qayta qurildi; 360×800, 390×844 va 130% matn masshtabida tekshirildi.
- [x] Tasdiqlangan mobil baseline sayqal sprinti: kontekstual app-bar, uzun ism/tashkilot matni, request ID, status chip, statistika tile'lari, bottom navigation, touch target va accessibility holatlari yaxshilandi; 320–1280px, uzun Uzbek matni va 130% shrift masshtabida tekshirildi.
