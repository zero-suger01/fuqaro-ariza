...
Audit sanasi: 2026-07-24, `main` (B1+B2+B3+B5.4 backend to'liq, B4 deyarli to'liq — faqat Telegram/B4.2 qolgan; F1+F2+F3 frontend to'liq — AI coder solo sessiya). Bu hujjat — "nima bor, nima yo'q" ning haqiqiy manzarasi. Yangi tasklar shu gap'lardan kelib chiqqan.
...
| Admin panel | **Tayyor** (F2+F3.2) — ro'yxat, tafsilot, status/biriktirish/javob, bo'lim/xodim/kategoriya/keyword/QR CRUD, dashboard, RBAC. Qolgan: heatmap/KPI (F4) | [06](06-frontend-tasklar.md) F4 |
...
5. **B5.1-B5.3/F4** — analitika (heatmap/KPI/eksport) — pilot ma'lumot to'planganidan keyin qiymatliroq.
